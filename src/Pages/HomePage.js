            ...
            <div id="HomePageContainer">
                ...
                <div id="HomePageSec2">
                    ...
                    <div id="HomePageSec2Main">
                        <div id="BillMe">
                            <div id="BillMeText">
                                <div id="BillMeTextHeader">Bill Me</div>
                                <div id="BillMeTextBody">BillMe is a simplified invoicing app allows<br /> users to send email invoices and
                                    enables<br /> clients to securely enter their card details.
                                </div>
                                <div id="BillMeTextBody2" onClick={GoToBillMe}>Read case study<img id="SmallArrowImg" src={SmallArrowImg} alt="SmallArrowImg" /></div>
                            </div>
                            <div id="PhonesImgDiv">
                        ...
                        <div id="TicketOne">
                            <div id="TicketOneText">
                                <div id="TicketOneTextHeader">TicketOne</div>
                                <div id="TicketOneTextBody">TicketOne is an app designed for vehicle<br /> owners and drivers in Canada which enables<br /> users to pay tickets and provides contact<br /> information for disputing them.
                                </div>
                                <div id="TicketOneTextBody2" onClick={GoToTicketOne}>Read case study<img id="SmallArrowImg" src={SmallArrowImg2} alt="SmallArrowImg" /></div>
                            </div>
